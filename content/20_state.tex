...
Interface Forum \cite{ref:mpi_specification}.Implementations area
available on virtually every parallel computer systems and has become
...
abstractraction provided by the underlying system (sockets, AM, etc.)
