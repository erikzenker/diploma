...
%                                                                              %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
This chapter gives on one hand all necessary background information
for understanding the foundation of the developed system and on the
other hand an introduction in the topic by work that has been done so
far. The reader with existing knowledge in the field of cluster
computing can skip this chapter and return on demand.
...
\todo{Bring this in a order and evaluate the work}
\todo{order from work not related to own system to work strongly related}
