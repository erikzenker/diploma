...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Checked
\subsection{Transformation of Binary Operators}
...
operator \cpp{op} from type \cpp{T\_BinaryOperation} with result data type
\cpp{T\_Data}.  After the
...
\cpp{id}, as presented in Listing \ref{lst:property}. This \cpp{id} is
necessary since it is used to create an internal mapping of the
property to the vertex index of the BGL.  The \cpp{SimpleProperty} is
...
\item Configure the graph
  ...
  provides type definitions for \cpp{Vertex} and  \cpp{Edge}:
